...
_lr_productions = [
  ...
  ('operador -> MAS','operador',1,'p_operador','sintactico.py',19),
  ('operador -> MENOS','operador',1,'p_operador','sintactico.py',20),
  ('operador -> MULTIPLICA','operador',1,'p_operador','sintactico.py',21),
  ('operador -> DIVIDE','operador',1,'p_operador','sintactico.py',22),
  ('operador -> MODULO','operador',1,'p_operador','sintactico.py',23),
  ('operador -> EXPONENCIACION','operador',1,'p_operador','sintactico.py',24),
  ('operacionMatematica -> VARIABLE_PHP IGUAL VARIABLE_PHP operador VARIABLE_PHP PUNTOYCOMA','operacionMatematica',6,'p_operacionMatematica','sintactico.py',31),
  ('operacionMatematica -> VARIABLE_PHP IGUAL VARIABLE_PHP operador tipoDevalorNumerico PUNTOYCOMA','operacionMatematica',6,'p_operacionMatematica','sintactico.py',32),
  ('tipoDevalorNumerico -> ENTERO','tipoDevalorNumerico',1,'p_tipoDevalorNumerico','sintactico.py',36),
  ('tipoDevalorNumerico -> FLOTANTE','tipoDevalorNumerico',1,'p_tipoDevalorNumerico','sintactico.py',37),
  ('tipoDeDato -> ENTERO','tipoDeDato',1,'p_tipoDeDato','sintactico.py',42),
  ('tipoDeDato -> FLOTANTE','tipoDeDato',1,'p_tipoDeDato','sintactico.py',43),
  ('tipoDeDato -> CADENA','tipoDeDato',1,'p_tipoDeDato','sintactico.py',44),
  ('tipoDeDato -> VARIABLE_PHP','tipoDeDato',1,'p_tipoDeDato','sintactico.py',45),
  ('tipoDeDato -> BOOLEANO','tipoDeDato',1,'p_tipoDeDato','sintactico.py',46),
  ('tipoDeDato -> NULL','tipoDeDato',1,'p_tipoDeDato','sintactico.py',47),
  ('parametros -> tipoDeDato','parametros',1,'p_parametros','sintactico.py',52),
  ('parametros -> tipoDeDato COMA parametros','parametros',3,'p_parametros','sintactico.py',53),
  ('foreach -> FOREACH PARENIZQ VARIABLE_PHP AS AMPERSAND VARIABLE_PHP PARENDER LLAVEIZQ operacionMatematica LLAVEDER','foreach',10,'p_foreach','sintactico.py',60),
  ('arraymaps -> OPERAMAPA PARENIZQ parametros PARENDER PUNTOYCOMA','arraymaps',5,'p_arraymaps','sintactico.py',67),
  ('arraymaps -> VARIABLE_PHP IGUAL OPERAMAPA PARENIZQ parametros PARENDER PUNTOYCOMA','arraymaps',7,'p_arraymaps','sintactico.py',68),
  ('funcion -> NEW NOMBRE PARENIZQ PARENDER PUNTOYCOMA','funcion',5,'p_funcion','sintactico.py',73),
  ('monticuloHEAP -> HEAP IGUAL funcion','monticuloHEAP',3,'p_monticuloHEAP','sintactico.py',78),
]
